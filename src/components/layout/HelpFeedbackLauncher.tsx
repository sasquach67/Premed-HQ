...
export function HelpFeedbackLauncher() {
  ...
  return (
    <>
      <button type="button" onClick={() => setOpen(true)} className="fixed bottom-4 left-4 z-40 grid size-10 place-items-center rounded-full border border-border bg-card text-sm font-extrabold shadow-lg transition-transform duration-200 hover:-translate-y-0.5 hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary lg:left-[17rem]" aria-label="Help and feedback" title="Help and feedback (?)">?</button>
